...
<head>
  ...
  <title>Demir İK | Admin Paneli </title>
          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            ...
            <div class="menu_section">
              ...
              <ul class="nav side-menu">
                ...
                <li><a href="basvurular.php"><i class="fa fa-user"></i> Başvurular<span class="label label-success pull-right">

                  <?php echo $say3; ?></span></a></li>

                  
                  <li><a href="maillerim.php"><i class="fa fa-envelope"></i> Posta Kutusu<span class="label label-success pull-right">

                    <?php echo $say4; ?></span></a></li>
                    <li><a href="admin.php"><i class="fa fa-user-secret"></i> Admin Ekle</a></li>
