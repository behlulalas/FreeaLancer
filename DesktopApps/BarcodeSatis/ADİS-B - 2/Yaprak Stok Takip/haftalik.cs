...
{
    public partial class haftalik : Form
    {
        public haftalik()
        {
            InitializeComponent();
        ...
        private void haftalik_Load(object sender, EventArgs e)
        {
        ...
        public void Ara()
        {
            ...
            string sql = "Select * from raporlar where YEARWEEK(tarih,1)=YEARWEEK(CURDATE(),1)";
        ...
        public void Ara2()
        {
            ...
            string sql = "Select * from raporlar where YEARWEEK(tarih,1)=YEARWEEK('" + selectDateAsString + "',1)";
            DataTable dt = new DataTable();
            MySqlDataAdapter adapter = new MySqlDataAdapter();
            MySqlCommand command = new MySqlCommand();
            command.CommandText = sql;
