...
{
    public partial class yillik : Form
    {
        public yillik()
        {
            InitializeComponent();
        ...
        private void yillik_Load(object sender, EventArgs e)
        {
        ...
        public void Ara()
        {
            ...
            string sql = "Select * from raporlar where YEAR(tarih)=YEAR(CURDATE())";
        ...
        public void Ara2()
        {
            ...
            string sql = "Select * from raporlar where YEAR(tarih)=YEAR('" + selectDateAsString + "')";
            DataTable dt = new DataTable();
            MySqlDataAdapter adapter = new MySqlDataAdapter();
            MySqlCommand command = new MySqlCommand();
            command.CommandText = sql;
