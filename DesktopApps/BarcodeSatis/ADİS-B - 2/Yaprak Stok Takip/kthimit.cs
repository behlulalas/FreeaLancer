...
{
    public partial class kthimit : Form
    {
        public kthimit()
        {
            InitializeComponent();
        ...
        public void Ara2()
        {
            ...
            string sql = "Select * from iade where tarih='" + selectDateAsString + "'";
        ...
        public void Ara()
        {
            ...
            string sql = "Select * from iade where tarih=CURDATE()";
            DataTable dt = new DataTable();
            MySqlDataAdapter adapter = new MySqlDataAdapter();
            MySqlCommand command = new MySqlCommand();
            command.CommandText = sql;
        ...
        private void kthimit_Load(object sender, EventArgs e)
        {
